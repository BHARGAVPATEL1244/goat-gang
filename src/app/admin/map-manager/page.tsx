...
export default function MapManagerPage() {
    ...
    return (
        <div className="p-8 text-white min-h-screen">
            ...
            {/* Editor Form */}
            <div id="editor-form" className="bg-gray-800 p-4 rounded-xl border border-gray-700 mb-8 sticky top-4 z-20 shadow-2xl">
                ...
                <div className="space-y-4">
                    ...
                    <div className="flex flex-col md:flex-row gap-3">
                        <div className="flex gap-3">
                            <div className="w-16 flex-shrink-0">
                                ...
                                <input
                                    type="color"
                                    className="w-full h-[38px] rounded cursor-pointer bg-transparent border border-gray-700 p-0"
                            ...
                            <div className="w-20 flex-shrink-0">
                                ...
                                <input
                                    type="number"
                                    className="bg-gray-900 border border-gray-700 rounded p-2 w-full text-center font-mono text-yellow-500 font-bold text-sm h-[38px]"
                        ...
                        <div className="flex-1">
                            ...
                            <input
                                ...
                                className="bg-gray-900 border border-gray-700 rounded p-2 w-full text-sm font-bold h-[38px]"
                        ...
                        <div className="flex gap-3">
                            <div className="w-full md:w-24 flex-shrink-0">
                                ...
                                <input
                                    ...
                                    className="bg-gray-900 border border-gray-700 rounded p-2 w-full text-sm h-[38px]"
                            ...
                            <div className="w-full md:w-40 flex-shrink-0">
                                ...
                                <input
                                    ...
                                    className="bg-gray-900 border border-gray-700 rounded p-2 w-full font-mono text-xs h-[38px]"
                    ...
                    <div className="flex flex-col md:flex-row gap-4 items-start md:items-end">
                        <div className="grid grid-cols-3 gap-2 w-full md:w-auto">
                            <div className="w-full md:w-20">
                                <label className="text-[10px] text-yellow-500 block mb-1 text-center font-bold">GOLD</label>
                                <input
                                    type="number"
                                    className="bg-gray-900 border border-gray-700 rounded p-2 w-full text-center font-bold text-sm"
                                    value={formData.trophy_gold} onChange={e => setFormData({ ...formData, trophy_gold: parseInt(e.target.value) || 0 })}
                                />
                            </div>
                            <div className="w-full md:w-20">
                                <label className="text-[10px] text-gray-400 block mb-1 text-center font-bold">SILVER</label>
                                <input
                                    type="number"
                                    className="bg-gray-900 border border-gray-700 rounded p-2 w-full text-center font-bold text-sm"
                            ...
                            <div className="w-full md:w-20">
                                <label className="text-[10px] text-orange-500 block mb-1 text-center font-bold">BRONZE</label>
                                <input
                                    type="number"
                                    className="bg-gray-900 border border-gray-700 rounded p-2 w-full text-center font-bold text-sm"
                        ...
                        <div className="flex-1 w-full">
                            ...
                            <div className="flex gap-2">
                                <input
                                    ...
                                    className="bg-gray-900 border border-gray-700 rounded p-2 w-full text-xs h-[38px]"
                                    value={formData.image_url}
                                    onChange={e => setFormData({ ...formData, image_url: e.target.value })}
                                />
                                <label className="cursor-pointer bg-blue-600 hover:bg-blue-500 px-4 rounded flex items-center justify-center text-xs font-bold h-[38px] whitespace-nowrap">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-3 bg-black/20 p-3 rounded border border-white/5">
                        <div>
                            <label className="text-[10px] text-yellow-500 uppercase font-bold mb-1 block">Fixed Leader ID (Required)</label>
                            <input
                        ...
                        <div>
                            <label className="text-[10px] text-gray-500 uppercase font-bold mb-1 block">Fixed Co-Leader IDs (Optional)</label>
                            <input
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                        <textarea
                            ...
                            className="w-full bg-gray-900 border border-gray-700 rounded p-3 text-xs"
                    ...
                    <div className="pt-2 flex flex-col-reverse md:flex-row gap-3 justify-end border-t border-gray-700">
                        {editingId && (
                            <button onClick={() => { setEditingId(null); resetForm(); }} className="bg-gray-700 w-full md:w-auto px-6 py-3 md:py-2 rounded text-xs font-bold uppercase tracking-wider">
                                Cancel
                            </button>
                        )}
                        <button onClick={handleSave} className="bg-green-600 hover:bg-green-500 w-full md:w-auto px-8 py-3 md:py-2 rounded font-bold text-sm flex items-center justify-center gap-2 shadow-lg uppercase tracking-wider transition-all">
